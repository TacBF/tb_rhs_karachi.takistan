  ...
  class firstAid
  {
	...
	class mission
	{
		...
		recommendedTotalPlayers = 24;
              class briefings
        {
        // Provide file name containing side specific mission briefings here. File text can use structured text syntax. Use <br /> tag for line breakms.
        class west
              {
		...
		class factions // or sides
		{
            ...
            class teamName
            {
                bluFor = "Syrian Arab Army";
                opFor = "Daesh";
            };
            class teamFlag
            {
                bluFor = "flags\saa.jpg"; // "flags" is a sub-folder in mission folder
                opFor = "flags\daesh.jpg";
            };
		};
		class scoring
		{
...
/*        class vehicles
        {
            class respawnDelay
            {
                ...
                multiplier = 20; // set to > 0 to override scaled "vehicle category" values. Eg: 0.5 to halve all values. 1.5 to increase all values.
	    ...
	    class objectives
        {
            class zones
            {
                class captureRates
                {
                    ...
                    neutralZoneMultiplier = 3; // Decimal value between 0 and N. (> 0, < 1 will reduce capture rate), (> 1 will increase capture rate)
...
#define __unlimited -99
            kits[] =
            {
                // BLUFOR or ALL factions
                {
                    ...
                    {__ICE_gear_Grenadier, "Grenadier", 7, 1, 0, 3},
                    {__ICE_gear_MG, "MG", 7, 0, 0, 3},
                    {__ICE_gear_Medic, "Medic", 4, 2, 0, 2},
                    {__ICE_gear_CombatEngineer, "Combat Engineer", 5, 0, 0, 3},
                    {__ICE_gear_LightAT, "Light AT", 5, 0, 0, 4},
                    {__ICE_gear_HeavyAT, "Heavy AT", 7, 0},
                    {__ICE_gear_AA, "Anti-Air", 0, 0, 0, 4},
                    {__ICE_gear_Marksman, "Marksman", 15, 0, 0, 4},
                    {__ICE_gear_Sniper, "Sniper", 20, 0, 0, 4},
                    ...
                    {__ICE_gear_Diver, "Mujahedin", 15, 0, 0, 2}
                },
